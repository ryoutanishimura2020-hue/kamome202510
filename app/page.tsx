        ...
        <section id="about" className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li><strong>起業家精神の真髄に触れる：</strong> 横浜ゆかりの起業家が、失敗を恐れず挑戦を続けるリアルな体験をシェア。</li>
              <li><strong>社会課題へのアプローチを学ぶ：</strong> 難民問題や健康医療など、最前線で活躍する実務者から直接学べる。</li>
              <li><strong>未来を創る仲間と出会う：</strong> 次世代リーダーの熱量や斬新な発想に触れ、次の一歩を踏み出すために勇気を得られる。</li>
              <li><strong>意外なキャリアの可能性を発見：</strong> 難病への向き合い方、生成AI活用など、あなたのスキルが活きる思わぬフィールドが見つかるかも。</li>
            </ul>
            <p className="text-lg">
