    ...
    sessions: [
      {
        ...
        description: 'ファウンダー（新しい組織・事業を作ってチャンスをとらえようとする個人）である参加者の皆様は、これから一歩を踏み出す際に、多くの意思決定を意図的に行う必要があります。そこには、いくつものジレンマが存在しています。本セッションでは、企業で遺伝子解析の技術者として活躍された後に起業された小野秀彰氏をお迎えし、Tech技術者が独学でビジネスを学び、数々のジレンマをどのように乗り越えて今に至ったのかについて、参加者の皆様と共に掘り下げるセミナーを予定しています。',
        speakers: [
          { 
            name: '小野 秀彰 氏', 
    ...
    sessions: [
      {
        ...
        description: '本セッションでは、医療従事者（鍼灸師）・トレーナーをされているBACK AGINGの和田有稀奈氏をお迎えします。和田氏は女子サッカー選手を志すも、5年間で3度の膝の手術を経験し、満足のいく現役時代を送れなかった経験から、「挑戦を諦める人を減らしたい」という思いで医療従事者（鍼灸師）となりました。その後、イタリア女子フットサル代表のトレーナー活動などを経て、現職に至っていらっしゃいます。今回は、志の変遷についてのお話と併せて、ビジネスパーソン向けのお身体チェックを行います。',
        speakers: [
          { 
            name: '和田 有稀奈 氏', 
    ...
    sessions: [
      {
        ...
        description: '生成AIに関する様々な知見を発信されているIkigai lab.の髙橋さんをお招きし、生成AIの「一丁目一番地」ともいえる基礎をしっかりと押さえる45分にしたいと思います。ChatGPTをはじめとする生成AIは急速に進化しており、ビジネスの現場でも「調査・資料作成・アイデア発想・顧客対応」など幅広く活用されています。その一方で、正しく使うための前提知識や注意点を理解していないと、誤解やリスクにつながりかねません。本セッションでは、最新の動向や代表的な活用シーンも交えながら、基礎を体系的に学びます。「なぜ今、生成AIを学ぶ必要があるのか」「どこから手を付けるべきか」といった問いに答えつつ、皆さまが今後の実務に自信を持って活かせるようになることを目指します。',
        speakers: [
          { 
            name: '髙橋　和馬 氏', 
...

      {
        ...
        speakers: [
          { name: '大上 高充 氏', 
            ...
            organization2: '中小機構 Science Tokyo 横浜ベンチャープラザ チーフインキュベーションマネージャ', 
            position: '同志社大学　ビジネス研究科 客員教授',
            info: '',
            image: '/登壇者_F_1.png'
          },
        ]
            ...
            {session.speakers.map((speaker, speakerIndex) => (
              <div key={speakerIndex} className="flex items-center bg-[#79a7b6] text-white p-2 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs">{speaker.organization2}</p>
