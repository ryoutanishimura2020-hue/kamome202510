        ...
        <section id="about" className="py-20 bg-white">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>社会課題へのアプローチを学ぶ：</strong> 未病対策やサーキュラーエコノミーなど、最前線で活躍する実務者から直接学べる。</li>
              <li><strong>未来を創る仲間と出会う：</strong> 「ヨコハマ未来創造会議」のような次世代リーダーの斬新な発想に触れ、刺激を得られる。</li>
              <li><strong>意外なキャリアの可能性を発見：</strong> 難民対策、難病への向き合い方、生成AI活用など、あなたのスキルが活きる思わぬフィールドが見つかるかも。</li>
            </ul>
            <p className="text-lg">
