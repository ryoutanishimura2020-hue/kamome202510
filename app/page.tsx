          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="bg-[#f4f4f4] p-6 rounded-lg shadow-md mb-8">
              ...
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
               ...
               <a href="https://mba.globis.ac.jp/inquiry/#yokohama" target="_blank" rel="noopener noreferrer" className="bg-gray-400 text-red px-4 py-2 rounded /*cursor-not-allowed*/" /*disabled*/>
                  チケット購入
               </a>
